...
var url = 'https://newsapi.org/v2/top-headlines?country=br&category=sports&from=2019-11-06&sortBy=popularity&language=pt&apiKey=87a7928e6caa4869a1c8afe853284ace';

var request = function request() {
  try {
    Axios.get(url).then(function (e) {
      return init(e.data.articles);
    });
  } catch (err) {
    return 'deu erro:' + err;
  }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "44863" + '/');
